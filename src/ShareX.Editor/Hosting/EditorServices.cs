...
public static class EditorServices
{
    ...
    public static void EnsureDefaultDesktopWallpaperService()
    {
        ...
        // The Windows branch is removed rather than left dangling: its service
        // was a user32 P/Invoke and this port has no Windows target. Upstream
        // already shipped the macOS and Linux implementations next to it, so
